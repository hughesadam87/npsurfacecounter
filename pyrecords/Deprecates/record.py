...
def recordtype(typename, field_names, verbose=False, **default_kwds):
    ...
    Missing some functions of the named tuple, like _make()
...
if __name__ == '__main__':
    DomainsCDD=recordtype('DomainsCDD', 'length, width, height', verbose=True, field_defaults={'width':40, 'length':32, 'height':3})
    a=DomainsCDD()
    print a